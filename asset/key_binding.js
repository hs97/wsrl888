...
Game.KeyBinding.BindingSet.numpad.MOVE_UL   = {label:'7' ,inputMatch:ROT.VK_7 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_U    = {label:'8' ,inputMatch:ROT.VK_8 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_UR   = {label:'9' ,inputMatch:ROT.VK_9 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_L    = {label:'4' ,inputMatch:ROT.VK_4 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_WAIT = {label:'5' ,inputMatch:ROT.VK_5 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_R    = {label:'6' ,inputMatch:ROT.VK_6 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_DL   = {label:'1' ,inputMatch:ROT.VK_1 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_D    = {label:'2' ,inputMatch:ROT.VK_2 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.MOVE_DR   = {label:'3' ,inputMatch:ROT.VK_3 ,inputType:'keydown' ,inputMetaShift:false ,inputMetaCtrl:false};
